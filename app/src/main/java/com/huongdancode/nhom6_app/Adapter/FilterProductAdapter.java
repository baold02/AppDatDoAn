...
public class FilterProductAdapter extends RecyclerView.Adapter<FilterProductAdapter.FilterProductViewHolder> implements Filterable {
    ...
    @NonNull
    @Override
    public FilterProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FilterProductViewHolder holder, int position) {
